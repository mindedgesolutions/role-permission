...
import { setListSellers } from "../../features/userSlice";
import {
  PageHeader,
  PageWrapper,
  PaginationContainer,
...
const SellerList = () => {
  document.title = `List of Providers | ${import.meta.env.VITE_ADMIN_TITLE}`;
  const returnUrl = `/admin/users/providers`;
  ...
  const { listSellers, currentUser } = useSelector((store) => store.users);
  ...
  const fetchData = async () => {
    setIsLoading(true);
    try {
      const response = await customFetch.get(`/users/all/${2}`, {
        params: {
      ...
      dispatch(setListSellers(response?.data?.data?.rows));
      ...
      <div className="page-header d-print-none">
        <div className="container-xl">
          <div className="row g-2 align-items-center">
            <PageHeader title={`List of all Providers (Admin only)`} />
        ...
        <div className="col-12">
          <div className="card">
            <div className="card-header">
              Total {totalRecords} sellers found
              <div className="col-auto ms-auto d-print-none">
                <Form method="GET">
                  <div className="btn-list">
                    <span className="d-none d-sm-inline">
